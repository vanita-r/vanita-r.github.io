document.addEventListener("DOMContentLoaded", function() {
    ...
    function displayResults() {
        ...
        linkInputs.forEach(function(link, index) {
            if (link.value) {
                // Create an <a> tag with custom text instead of the URL
        ...
        const resultsHtml = `
            ...
            ${imageUrl ? `
                <figure>
                    <img src="${imageUrl}" alt="${caption}" style="max-width:600px;">
    ...
    if (resetButton) {
        resetButton.addEventListener("click", function() {
            // 1. Remove extra courses
            removeDynamicCourses();
            
            // 2. Clear the image preview
            ...
            // Note: The browser will clear the text boxes automatically
        });
    }
    ...
    if (clearButton) {
        clearButton.addEventListener("click", function() {
            // Remove dynamically added courses
            removeDynamicCourses();
